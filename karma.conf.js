...
module.exports = function(config) {
  config.set({
    ...
    files: [
      ...
      {pattern: resolver.resolveModulePath('opensphere/vendor/angular-ui/angular-ui.js'), watched: false, included: true, served: true},
      ...
      // load opensphere test initialization
      resolver.resolveModulePath('opensphere/test/init.js'),
